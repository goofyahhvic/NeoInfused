...
namespace neo {
    ...
    public:
        ...
        static inline SDL_Texture* GetTexture(const id_t id) { return TextureRegistry::m_Registry[id]; }

        static id_t FindFirstOf(SDL_Texture* texture);
        static id_t FindLastOf(SDL_Texture* texture);

        static inline index_t Size(void) { return TextureRegistry::m_Registry.size(); }

        static inline std::vector<SDL_Texture*> GetRegistry(void) { return TextureRegistry::m_Registry; }
        static inline const std::vector<SDL_Texture*>& GetRegistryR(void) { return TextureRegistry::m_Registry; }
    private:
        static id_t _PushTexture(SDL_Texture* texture);
    ...
    private:
        static std::vector<SDL_Texture*> m_Registry;
    };
} // namespace neo
