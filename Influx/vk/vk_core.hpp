...
#define INFVK_TRACE_LOG(...) std::clog << NEO_FORMAT(NEO_FONT_BOLD                "[{0}][Inf-Vk]" NEO_COLOR_RSET " {1}\n", std::format("{:%X}", std::chrono::zoned_time(std::chrono::current_zone(), std::chrono::system_clock::now())), NEO_FORMAT(__VA_ARGS__)) 
#define INFVK_INFO_LOG(...)  std::clog << NEO_FORMAT(NEO_FONT_BOLD NEO_COLOR_FGRN "[{0}][Inf-Vk]" NEO_COLOR_RSET " {1}\n", std::format("{:%X}", std::chrono::zoned_time(std::chrono::current_zone(), std::chrono::system_clock::now())), NEO_FORMAT(__VA_ARGS__)) 
#define INFVK_WARN_LOG(...)  std::clog << NEO_FORMAT(NEO_FONT_BOLD NEO_COLOR_FYEL "[{0}][Inf-Vk]" NEO_COLOR_RSET " {1}\n", std::format("{:%X}", std::chrono::zoned_time(std::chrono::current_zone(), std::chrono::system_clock::now())), NEO_FORMAT(__VA_ARGS__)) 
#define INFVK_ERROR_LOG(...) std::clog << NEO_FORMAT(NEO_FONT_BOLD NEO_COLOR_FRED "[{0}][Inf-Vk]" NEO_COLOR_RSET " {1}\n", std::format("{:%X}", std::chrono::zoned_time(std::chrono::current_zone(), std::chrono::system_clock::now())), NEO_FORMAT(__VA_ARGS__))
#define INFVK_FATAL_LOG(...) std::clog << NEO_FORMAT(NEO_FONT_BOLD NEO_COLOR_BRED "[{0}][Inf-Vk]" NEO_COLOR_RSET " {1}\n", std::format("{:%X}", std::chrono::zoned_time(std::chrono::current_zone(), std::chrono::system_clock::now())), NEO_FORMAT(__VA_ARGS__))

#else
#define INFVK_TRACE_LOG(...)
#define INFVK_INFO_LOG(...)
#define INFVK_WARN_LOG(...)
#define INFVK_ERROR_LOG(...)
#define INFVK_FATAL_LOG(...)
