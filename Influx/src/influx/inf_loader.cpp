...
namespace inf {
	void Loader::Load(renderer_api_t api)
	{
		...
		create_shader_pipeline = m_Lib.fn<create_shader_pipeline_fn>("CreateShaderPipeline");
		destroy_shader_pipeline = m_Lib.fn<destroy_shader_pipeline_fn>("DestroyShaderPipeline");
		...
		init_shader_pipeline = m_Lib.fn<init_shader_pipeline_fn>("InitShaderPipeline");
